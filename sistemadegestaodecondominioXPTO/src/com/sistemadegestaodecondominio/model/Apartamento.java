...
public class Apartamento extends Fracao {
  ...
  public String toString() {
    ...
    return String.format(obj,this.id,this.area, this.percentagem, this.localizacao, this.proprietario.getId(), this._tipo, this._nVarandas, this._nCasasDeBanho, this._temTerraco);
  }

  public Apartamento Deserialization(String object) {
